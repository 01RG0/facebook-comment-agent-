...
export async function PATCH(
  ...
  if ('preferred_ai_key_ids' in body) update.preferred_ai_key_ids = Array.isArray(body.preferred_ai_key_ids) ? body.preferred_ai_key_ids : []
